...
//  ZCWBaseApp
//
//  Created by yupeng xia on 2020/9/2.
...
- (void)makeContentView {
    ...
    if (_topScrollView == nil) {
        ...
        _topScrollView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
...
- (void)layoutSubviewsCustom {
    ...
    for (int i = 0; i < _contentArray.count; i++) {
        ...
        [aContent.btn setFont:aContent.btnFont];
